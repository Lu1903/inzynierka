...
@Route("setNewPasswordAdmin")
public class SetNewPasswordAdmin extends AdminMenu {
	...
	@Autowired
	public SetNewPasswordAdmin(UserRepo userRepo, PasswordEncoder passwordEncoder) {
	...
	public void setGrid() {
		...
		editor.addSaveListener(event -> {
			saveNewPassword(password.getValue(), openedUser.getId());
			editor.refresh();
			editor.cancel();
	...
	@Transactional
	private void saveNewPassword(String password, long id) {
		userRepo.setUserPassword(passwordEncoder.encode(password), id);
	}
}