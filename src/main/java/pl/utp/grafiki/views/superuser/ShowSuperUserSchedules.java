...
@Route("showSuperUserSchedules")
@Secured("ROLE_SUPERUSER")
@PageTitle("Edytuj grafiki")
public class ShowSuperUserSchedules extends SuperUserMenu {
	...
	@Autowired
	public ShowSuperUserSchedules(DayRepo dayRepo, UserRepo userRepo) {
	...
	public HorizontalLayout addButtons() {
		...
		return new HorizontalLayout(saveAll, weeklyView, monthlyView, previous, next);
	}
